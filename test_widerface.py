...
parser.add_argument('--save_folder', default='./widerface_evaluate/widerface_txt_lr0001/',
                    type=str, help='Dir to save txt results')
parser.add_argument('--cpu', default=False, help='Use cpu inference')
parser.add_argument('--dataset_folder',
                    default='/data/remote/dataset/wider_face/widerface/val/images/', type=str, help='dataset path')
